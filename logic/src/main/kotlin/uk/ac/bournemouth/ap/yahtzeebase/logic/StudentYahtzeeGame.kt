...
class StudentYahtzeeGame(
    ...
    override val players get() = listOf(
        HumanPlayer("Player 1"),
        HumanPlayer("Player 2")
    )
    // field back property??
     ...
     * probably better to just store it. FINISH THIS PART LATER CHECK WHETHER GAME IS FINISHED
     */
     ...
     * getter. ONLY RETURNS PLAYER 1 FIX LATER
     */
    override val currentPlayer: Player get() = players.elementAt(0)
     ...
     * @see [arrayOfNulls]
     */
    override val dice: Array<Int?> get() = arrayOfNulls(5)
